...
extern DSTATUS USER_SPI_SD_initialize (void);
extern DSTATUS USER_SPI_SD_status (void);
extern DRESULT USER_SPI_SD_read (BYTE *buff, DWORD sector, UINT count);
#if _USE_WRITE == 1
  extern DRESULT USER_SPI_SD_write (const BYTE *buff, DWORD sector, UINT count);
#endif /* _USE_WRITE == 1 */
#if _USE_IOCTL == 1
  extern DRESULT USER_SPI_SD_ioctl (BYTE cmd, void *buff);
#endif /* _USE_IOCTL == 1 */
