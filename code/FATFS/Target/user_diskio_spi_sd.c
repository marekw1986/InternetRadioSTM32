...
inline DSTATUS USER_SPI_SD_initialize (void)
{
	BYTE n, cmd, ty, ocr[4];
...
inline DSTATUS USER_SPI_SD_status (void)
{
...
inline DRESULT USER_SPI_SD_read (
...
#if _USE_WRITE
inline DRESULT USER_SPI_SD_write (
...
#if _USE_IOCTL
inline DRESULT USER_SPI_SD_ioctl (
...
)
{
	...
	case CTRL_TRIM :	/* Erase a block of sectors (used when _USE_ERASE == 1) */
		...
		if (USER_SPI_SD_ioctl(MMC_GET_CSD, csd)) break;	/* Get CSD */
